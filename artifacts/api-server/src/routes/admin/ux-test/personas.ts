...
export const PERSONAS: Persona[] = [
  {
    ...
    assessmentData: {
      ...
      riskConcerns: ["job_loss", "financial_crisis", "cyber_attack"],
      mentalResilienceAnswers: {
        stressTolerance1: 4,
        stressTolerance2: 4,
        adaptability1: 4,
  ...
  },
  {
    ...
    assessmentData: {
      ...
      riskConcerns: ["natural_disaster", "illness", "supply_chain"],
      mentalResilienceAnswers: {
        stressTolerance1: 3,
        stressTolerance2: 4,
        adaptability1: 3,
  ...
  },
  {
    ...
    assessmentData: {
      ...
      riskConcerns: ["job_loss", "illness", "natural_disaster"],
      mentalResilienceAnswers: {
        stressTolerance1: 2,
        stressTolerance2: 2,
        adaptability1: 3,
  ...
  },
  {
    ...
    assessmentData: {
      ...
      savingsMonths: 1,
      dependentCount: 2,
      relocationReadiness: "within_3months",
      ...
      hasEmergencySupplies: false,
      psychologicalResilience: 6,
      riskConcerns: ["political_instability", "job_loss", "illness"],
      mentalResilienceAnswers: {
        stressTolerance1: 4,
        stressTolerance2: 3,
        adaptability1: 5,
  ...
  },
  {
    ...
    assessmentData: {
      ...
      savingsMonths: 6,
      dependentCount: 2,
      relocationReadiness: "within_month",
      ...
      hasEmergencySupplies: true,
      psychologicalResilience: 7,
      riskConcerns: ["natural_disaster", "financial_crisis", "cyber_attack"],
      mentalResilienceAnswers: {
        stressTolerance1: 5,
        stressTolerance2: 5,
        adaptability1: 4,
  ...
  },
  {
    ...
    assessmentData: {
      ...
      riskConcerns: ["financial_crisis", "cyber_attack", "job_loss"],
      mentalResilienceAnswers: {
        stressTolerance1: 5,
        stressTolerance2: 4,
        adaptability1: 5,
  ...
  },
  {
    ...
    assessmentData: {
      ...
      riskConcerns: ["illness", "natural_disaster", "supply_chain"],
      mentalResilienceAnswers: {
        stressTolerance1: 2,
        stressTolerance2: 3,
        adaptability1: 2,
  ...
  },
  {
    ...
    assessmentData: {
      ...
      hasEmergencySupplies: false,
      psychologicalResilience: 5,
      riskConcerns: ["job_loss", "financial_crisis", "political_instability"],
      mentalResilienceAnswers: {
        stressTolerance1: 2,
        stressTolerance2: 3,
        adaptability1: 4,
