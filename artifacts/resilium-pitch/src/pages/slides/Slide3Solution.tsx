      ...
      <div className="relative h-full flex flex-col px-[8vw] py-[7vh]">
        ...
        <div className="flex gap-[3vw] flex-1">
          ...
          >
            ...
            >
              Financial runway, skills, health, mobility, housing, mental resilience deep-dive, and social capital — seven weighted dimensions, answered in under 10 minutes. Available in English & Romanian.
            </div>
          </div>
