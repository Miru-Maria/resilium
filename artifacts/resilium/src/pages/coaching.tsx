...
export default function CoachingPage() {
  ...
  useEffect(() => {
    ...
    setFromResilium(params.get("ref") === "resilium");
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: "8px", color: C.badgeText, textDecoration: "none", fontSize: "13px", fontWeight: 500 }}>
          <ArrowLeft size={14} />
          Back to Resilium
        </Link>
      </div>
      ...
      {/* Hero */}
      <section style={{ maxWidth: "680px", margin: "0 auto", padding: "72px 24px 56px", textAlign: "center" }}>
        <Badge>
        ...
        <h1 style={{
          ...
          <span style={{ color: C.gold }}>numbers can't measure.</span>
        </h1>

        <p style={{ fontSize: "18px", lineHeight: 1.7, color: C.bodyText, maxWidth: "560px", margin: "0 auto 36px" }}>
      ...
      <section style={{ background: C.sectionAlt, padding: "64px 24px" }}>
        <div style={{ maxWidth: "800px", margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ color: C.bodyText, lineHeight: 1.7, marginBottom: "40px", fontSize: "16px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "16px" }}>
            {[
              ...
              <div key={title} style={{
                ...
                <div style={{ fontSize: "14px", fontWeight: 700, color: C.headingDark, marginBottom: "8px" }}>{title}</div>
                <div style={{ fontSize: "14px", color: C.bodyText, lineHeight: 1.6 }}>{text}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ maxWidth: "800px", margin: "0 auto", padding: "64px 24px" }}>
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          <p style={{ color: C.bodyText, lineHeight: 1.7, fontSize: "16px", maxWidth: "520px", margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: "16px" }}>
          {[
            ...
            <div key={title} style={{
              ...
              <div>
                <div style={{ fontSize: "14px", fontWeight: 700, color: C.headingDark, marginBottom: "6px" }}>{title}</div>
                <div style={{ fontSize: "13px", color: C.bodyText, lineHeight: 1.6 }}>{text}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <section style={{ background: C.sectionAlt, padding: "64px 24px" }}>
        <div style={{ maxWidth: "680px", margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontSize: "16px", lineHeight: 1.8, color: C.fg, maxWidth: "560px", margin: "0 auto 24px" }}>
          ...
          <p style={{ fontSize: "15px", lineHeight: 1.7, color: C.bodyText, maxWidth: "520px", margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "20px" }}>
          {[
            ...
            <div key={step} style={{
              ...
              <div style={{ fontSize: "15px", fontWeight: 700, color: C.headingDark, marginBottom: "8px" }}>{title}</div>
              <div style={{ fontSize: "13px", color: C.bodyText, lineHeight: 1.6 }}>{text}</div>
            </div>
          ))}
        </div>
