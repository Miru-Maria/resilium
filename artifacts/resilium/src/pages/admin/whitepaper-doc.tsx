      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-10 space-y-14">
        ...
        <section id="privacy">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              { title: "Privacy by Design", items: ["All data encrypted in transit (TLS) and at rest", "User data never sold or shared with third parties", "Anonymous assessments auto-purged after 30 days", "Full GDPR compliance: export and deletion on request", "Data minimisation: only data needed for scoring is collected", "Versioned, timestamped consent on web and mobile", "Admin sessions use httpOnly cookies — token never accessible to JavaScript", "Content Security Policy on all surfaces: API (default-src 'none') and web (per-source allowlist)", "Admin action audit log: every login, logout, password change, and backup recorded with IP", "Automated daily database backups with 7-day rolling retention"] },
